                                        ...
                                        <div class="product-img-box col-lg-4 col-sm-5 col-xs-12">
                                            ...
                                            <div class="product-image">
                                                <div class="product-full">
                                                    <img id="product-zoom" src="到時候圖片網址要被取代"
                                                         data-zoom-image="到時候圖片網址要被取代" alt="product-image"/>
                                                </div>
                                                        ...
                                                        <div id="gallery_01"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="more-views-items">
                                                                    <a id="product-zoom01" href="#"
                                                                       data-image="到時候圖片網址要被取代"
                                                                       data-zoom-image="到時候圖片網址要被取代">
                                                                        <img id="product-zoom1" src="到時候圖片網址要被取代"
                                                                             alt="product-image"/>
                                                                    </a>
                                                                </div>
                                                                <div class="more-views-items">
                                                                    <a id="product-zoom02" href="#"
                                                                       data-image="到時候圖片網址要被取代"
                                                                       data-zoom-image="到時候圖片網址要被取代">
                                                                        <img id="product-zoom2" src="到時候圖片網址要被取代"
                                                                             alt="product-image"/>
                                                                    </a>
                                                                </div>
                                                                <div class="more-views-items">
                                                                    <a id="product-zoom03" href="#"
                                                                       data-image="到時候圖片網址要被取代"
                                                                       data-zoom-image="到時候圖片網址要被取代">
                                                                        <img id="product-zoom3" src="到時候圖片網址要被取代"
                                                                             alt="product-image"/>
                                                                    </a>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="product-shop col-lg-8 col-sm-7 col-xs-12">
                                            ...
                                            <div class="add-to-box">
                                                <div class="add-to-cart">
                                                    ...
                                                    <button
                                                            class="button btn-cart" title="Buy Direct" type="button">
                                                        直接購買
                                                    </button>
                                                ...
                                                <form id="review-form" method="post"
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <table id="product-review-table" class="data-table">
                                                            ...
                                                            <tr class="first odd">
                                                                ...
                                                                <td class="value"><input type="radio"
                                                                                         class="radio" value="11"
                                                                                         id="Price_1"
                                                                                         name="ratings[3]"></td>
                                                                <td class="value"><input type="radio"
                                                                                         class="radio" value="12"
                                                                                         id="Price_2"
                                                                                         name="ratings[3]"></td>
                                                                <td class="value"><input type="radio"
                                                                                         class="radio" value="13"
                                                                                         id="Price_3"
                                                                                         name="ratings[3]"></td>
                                                                <td class="value"><input type="radio"
                                                                                         class="radio" value="14"
                                                                                         id="Price_4"
                                                                                         name="ratings[3]"></td>
                                                                <td class="value last"><input type="radio"
                                                                                              class="radio" value="15"
                                                                                              id="Price_5"
                                                                                              name="ratings[3]"></td>
                                                            </tr>
                                                            <tr class="even">
                                                        ...
                                                        <div class="review1">
                                                            <ul class="form-list">
                                                                <li><label class="required"
                                                                           for="nickname_field">暱稱<em>*</em></label>
                                                                    <div class="input-box">
                                                                ...
                                                                <li><label class="required"
                                                                           for="summary_field">總結<em>*</em></label>
                                                                    <div class="input-box">
                                                                        <input type="text" class="input-text"
                                                        ...
                                                        <div class="review2">
                                                            <ul>
                                                                <li><label class="required "
                                                                           for="review_field">評論區<em>*</em></label>
                                                                    <div class="input-box">
...
<script>
    ...
    var settings = {
        "url": "http://bosian.ddns.net:8080/IIIFinalServlet_war_exploded/ProductServlet?pdaction=Select1&editProductId=35",
        "method": "POST",
        "timeout": 0,
    };
    ...
    $.ajax(settings).done(function (response) {
        ...
        $('#product-zoom1').attr("src", data[0].productImg1);
        $('#product-zoom2').attr("src", data[0].productImg2);
        $('#product-zoom3').attr("src", data[0].productImg3);

        //放大改圖應該在這邊但直接改<a>也沒有用
        $('#product-zoom').attr("data-image", data[0].productImg1);
        $('#product-zoom').attr("data-zoom-image", data[0].productImg1);

        $('#product-zoom01').attr("data-image", data[0].productImg1);
        $('#product-zoom01').attr("data-zoom-image", data[0].productImg1);

        $('#product-zoom02').attr("data-image", data[0].productImg1);
        $('#product-zoom02').attr("data-zoom-image", data[0].productImg1);

        $('#product-zoom03').attr("data-image", data[0].productImg1);
        $('#product-zoom03').attr("data-zoom-image", data[0].productImg1);
        //放大改圖應該在這邊但直接改<a>也沒有用
    });
    //Ted的方法，透過遠端載入所有圖片跟標題
